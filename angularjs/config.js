var extention = ".php/";
var host = "https://www.flatting.io.com/api/";
var base = "https://www.flatting.io.com/Get-Started";

var isLocal = true;

if (isLocal) {
    //base = "http://localhost:8080/flatting.io/web/Get-Started";
    //host = "http://localhost:8080/flatting.io/api/";
    base = "http://localhost:8080/flatting.io/Get-Started";//freedom
    host = "http://localhost:8080/flatting.io/api/"; //Freedom
}
